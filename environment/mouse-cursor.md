...
</code></pre></td><td>Useful when dragging elements within the interface.</td><td>A cross with the ends being arrows</td></tr><tr><td>Grab</td><td><pre class="language-javascript"><code class="lang-javascript">cursor "grab"
