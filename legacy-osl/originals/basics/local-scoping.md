...
This is the original originOS local-scoping page. It describes the old `local`
keyword and `this` scope object, which are not part of the current OSL compiler.
