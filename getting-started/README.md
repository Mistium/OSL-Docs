...
Run the bundled project-aware language server for indexed symbol and prefix-filtered keyword, builtin, method and snippet autocomplete, incremental document synchronization, inline errors, UTF-16-accurate go-to-definition, Markdown hover docs, multiline folding and document formatting:
